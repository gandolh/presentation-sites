...
- [architecture](wiki/architecture.md) — How this workspace is put together — the sites/ + packages/ layout, what @sites/kit shares, the shared Astro/Tailwind shape, the mock-vs-real image pipeline, the gitignored real-data split, and where deploy lives.
...
| design-study | [design-study/README.md](../sites/design-study/README.md) · [docs/styles/](../sites/design-study/docs/styles/README.md) |
